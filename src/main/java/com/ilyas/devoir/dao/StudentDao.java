package com.ilyas.devoir.dao;

import com.ilyas.devoir.model.Student;
...
public class StudentDao {
    private String jdbcURL = "jdbc:mysql://localhost/tpjee?useSSL=false";
    ...
    private static final String SELECT_STUDENT_BY_LastNAME="select id, first_name, last_name, student_id, school, study_option, registration_year from students where last_name =?";
...
// Step 4: Process the ResultSet object.
    ...
    public List<Student> selectStudentName(String lastName) {
