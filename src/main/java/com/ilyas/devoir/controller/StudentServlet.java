package com.ilyas.devoir.controller;

import com.ilyas.devoir.dao.StudentDao;
...
public class StudentServlet extends HttpServlet {
    ...
    private void chercher(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Student> chercher = studentDao.selectStudentName(lastName);
        request.setAttribute("listStudent", chercher);
